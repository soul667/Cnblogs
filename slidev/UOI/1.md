...
<!-- ![当前超快光学成像技术的比较。时间分辨率指的是快门速度或技术的帧时间。时间拉伸成像提供了一种独特的解决方案，时间分辨率范围从ns到μs，连续的重新编码时间与传统的CCD/CMOS相机相当。还需要注意的是，其他超快成像方式可以实现更高的时间分辨率，低至ps或更低。然而，它们以连续模式操作，即有限的连续记录时间。CUP:压缩超快摄影，STAMP:顺序定时全光映射摄影]() -->
